...
#  Version: 2.7 Build 03.03.2026 (IEX/IRM Optimized)
#  Framework: IT Groceries Shop (Layout Master)
# =========================================================

[System.Net.ServicePointManager]::SecurityProtocol = [System.Net.SecurityProtocolType]::Tls12

$AppVersion = "2.7 Build 03.03.2026"
...
if (-not $Silent -and -not $IsAdmin) {
    ...
    Write-Host "                    gRenam Remover [ Cloud Edition ]                      " -ForegroundColor Green -BackgroundColor Black
    Write-Host "                      Powered by IT Groceries Shop                        " -ForegroundColor DarkGreen -BackgroundColor Black
...
if ($Silent) { if ($ConsoleHandle) { [Win32.User32]::ShowWindow($ConsoleHandle, 0) | Out-Null } } else {
    try { $host.UI.RawUI.BufferSize = New-Object System.Management.Automation.Host.Size(80, 9999) } catch {}
    if ($ConsoleHandle) { 
...
if (!$Silent) {
    ...
    Write-Host "   (V.2.7 Build 03.03.2026 : INIT)      " -ForegroundColor Green
    ...
    <Grid Margin="25">
        ...
        <Grid Grid.Row="3" Margin="0,15,0,8">
            ...
            <StackPanel Grid.Column="1" Orientation="Vertical" HorizontalAlignment="Center" VerticalAlignment="Center">
                <Button x:Name="BA" Content="START SCAN" Width="300" Height="55" Background="#2E7D32" Foreground="White" Style="{StaticResource Btn}" Margin="0,0,0,5" Cursor="Hand" FontSize="18"/>
                <CheckBox x:Name="ChkAdv" Foreground="#FFCCCCCC" HorizontalAlignment="Center" Cursor="Hand" Margin="0,5,0,0">
                    <TextBlock x:Name="T_Adv" Text="Advance Mode: Recover hidden orphaned files" FontSize="13" Margin="5,0,0,0" Padding="0,0,0,8"/>
                </CheckBox>
            </StackPanel>
                ...
                foreach ($hiddenFile in $files) {
                    ...
                    if ($IsAdvance) {
                        if ($isHidden) {
                            ...
                            if (Test-Path $virusFullPath) { Remove-Item -Path $virusFullPath -Force -ErrorAction SilentlyContinue }
                            ...
                            if (Test-Path $virusFullPath) { $foundCount++ }
                        }
                    } else {
