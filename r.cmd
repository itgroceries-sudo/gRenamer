...
#  Version: 3.1 Build 04.03.2026 (IEX/IRM Optimized)
...
# [1] CONFIG & LANGUAGE
# ---------------------------------------------------------
$AppVersion = "3.1 Build 04.03.2026"
$InstallDir = "$env:LOCALAPPDATA\ITG_gRenamer"
$TempScript = "$env:TEMP\r.cmd"
$SelfURL    = "https://raw.githubusercontent.com/itgroceries-sudo/gRenamer/main/r.cmd"
...
# ---------------------------------------------------------
# [3] ELEVATION & IN-MEMORY DOWNLOAD LOGIC (WinUpdateFix Style)
# ---------------------------------------------------------
...
if (!$Silent) {
    ...
    Write-Host "   (V.3.1 Build 04.03.2026 : INIT)      " -ForegroundColor Green
...
<Window xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation"
        ...
        Title="gRenam Remover" Height="750" Width="650" WindowStartupLocation="Manual" ResizeMode="NoResize" 
        Background="#181818" WindowStyle="None" BorderBrush="#4CAF50" BorderThickness="2" FontFamily="Tahoma">
    <Window.Resources>
    ...
    <Grid Margin="25">
        ...
        <Grid Grid.Row="0">
            ...
            <StackPanel Grid.Column="1" VerticalAlignment="Center" Margin="5,0,0,0">
                <TextBlock x:Name="T_Title" Foreground="White" FontSize="26" FontWeight="Bold">
                ...
                <StackPanel Orientation="Horizontal" Margin="2,5,0,0">
                    <TextBlock x:Name="T_Dev" Foreground="#4CAF50" FontSize="14" FontWeight="Bold"/>
                </StackPanel>
            </StackPanel>
        ...
        <Grid Grid.Row="3" Margin="0,15,0,8">
            ...
            <StackPanel Grid.Column="1" Orientation="Vertical" HorizontalAlignment="Center">
                <Button x:Name="BA" Width="300" Height="48" Background="#2E7D32" Foreground="White" Style="{StaticResource Btn}" Cursor="Hand" FontSize="18"/>
                <CheckBox x:Name="ChkAdv" Foreground="#FFCCCCCC" HorizontalAlignment="Center" Cursor="Hand" Margin="0,12,0,0">
                    <TextBlock x:Name="T_Adv" FontSize="13" Margin="5,-2,0,0" Padding="0,0,0,5"/>
                </CheckBox>
            </StackPanel>
            ...
            <StackPanel Grid.Column="2" HorizontalAlignment="Right" VerticalAlignment="Top">
                <Button x:Name="BRefresh" Width="100" Height="48" Background="#1976D2" Foreground="White" Style="{StaticResource Btn}" Cursor="Hand">
                    <StackPanel Orientation="Horizontal">
                        ...
                        <TextBlock x:Name="T_Refresh" VerticalAlignment="Center" FontWeight="Bold" FontSize="14"/>
                    </StackPanel>
                </Button>
            </StackPanel>
        </Grid>
        ...
        <Grid Grid.Row="4">
            ...
            <StackPanel Orientation="Horizontal" Grid.Column="0">
                 <Button x:Name="BF" Style="{StaticResource LabeledBtn}"><StackPanel Orientation="Horizontal"><TextBlock Text="f" Foreground="#1877F2" FontSize="28" FontWeight="Bold" Margin="0,-4,8,0" VerticalAlignment="Center"/><TextBlock x:Name="T_FB" Foreground="White" VerticalAlignment="Center"/></StackPanel></Button>
                 <Button x:Name="BG" Style="{StaticResource LabeledBtn}"><StackPanel Orientation="Horizontal"><Viewbox Width="26" Height="26" Margin="0,0,8,0"><Path Fill="White" Data="M12 .297c-6.63 0-12 5.373-12 12 0 5.303 3.438 9.8 8.205 11.385.6.113.82-.258.82-.577 0-.285-.01-1.04-.015-2.04-3.338.724-4.042-1.61-4.042-1.61C4.422 18.07 3.633 17.7 3.633 17.7c-1.087-.744.084-.729.084-.729 1.205.084 1.838 1.236 1.838 1.236 1.07 1.835 2.809 1.305 3.495.998.108-.776.417-1.305.76-1.605-2.665-.3-5.466-1.332-5.466-5.93 0-1.31.465-2.38 1.235-3.22-.135-.303-.54-1.523.105-3.176 0 0 1.005-.322 3.3 1.23.96-.267 1.98-.399 3-.405 1.02.006 2.04.138 3 .405 2.28-1.552 3.285-1.23 3.285-1.23.645 1.653.24 2.873.12 3.176.765.84 1.23 1.91 1.23 3.22 0 4.61-2.805 5.625-5.475 5.92.42.36.81 1.096.81 2.22 0 1.606-.015 2.896-.015 3.286 0 .315.21.69.825.57C20.565 22.092 24 17.592 24 12.297c0-6.627-5.373-12-12-12"/></Viewbox><TextBlock x:Name="T_Git" Foreground="White" VerticalAlignment="Center"/></StackPanel></Button>
                 <Button x:Name="BAbt" Style="{StaticResource LabeledBtn}" Background="#607D8B"><StackPanel Orientation="Horizontal"><Viewbox Width="26" Height="26" Margin="0,0,8,0"><Path Fill="White" Data="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm1 17h-2v-2h2v2zm2.07-7.75l-.9.92C13.45 12.9 13 13.5 13 15h-2v-.5c0-1.1.45-2.1 1.17-2.83l1.24-1.26c.37-.36.59-.86.59-1.41 0-1.1-9-2-2-2s-2 .9-2 2H8c0-2.21 1.79-4 4-4s4 1.79 4 4c0 .88-.36 1.68-.93 2.25z"/></Viewbox><TextBlock x:Name="T_Abt" Foreground="White" VerticalAlignment="Center"/></StackPanel></Button>
                 <Button x:Name="BLang" Style="{StaticResource LabeledBtn}" Background="#444"><StackPanel Orientation="Horizontal"><Viewbox Width="26" Height="26" Margin="0,0,8,0"><Path Fill="White" Data="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-1 17.93c-3.95-.49-7-3.85-7-7.93 0-.62.08-1.21.21-1.79L9 15v1c0 1.1.9 2 2 2v1.93zm6.9-2.54c-.26-.81-1-1.39-1.9-1.39h-1v-3c0-.55-.45-1-1-1H8v-2h2c.55 0 1-.45 1-1V7h2c1.1 0 2-.9 2-2v-.41c2.93 1.19 5 4.06 5 7.41 0 2.08-.8 3.97-2.1 5.39z"/></Viewbox><TextBlock x:Name="T_Lang" Foreground="White" VerticalAlignment="Center"/></StackPanel></Button>
            </StackPanel>
            <StackPanel Orientation="Horizontal" Grid.Column="2" HorizontalAlignment="Right">
                <Button x:Name="BC" Width="100" Height="50" Background="#D32F2F" Foreground="White" Style="{StaticResource Btn}" Cursor="Hand" FontSize="16"/>
            </StackPanel>
        </Grid>
    </Grid>
</Window>
