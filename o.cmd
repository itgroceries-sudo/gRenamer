...
#  Version: 3.4 Build 04.03.2026 (IEX/IRM Optimized)
#  Framework: IT Groceries Shop (Layout Master)
# =========================================================

[System.Net.ServicePointManager]::SecurityProtocol = [System.Net.SecurityProtocolType]::Tls12

$AppVersion = "3.4 Build 04.03.2026"
$InstallDir = "$env:LOCALAPPDATA\ITG_gRenamer"
$TempScript = "$env:TEMP\o.cmd"
$SelfURL    = "https://raw.githubusercontent.com/itgroceries-sudo/gRenamer/main/o.cmd"
...
# ---------------------------------------------------------
# [4] MAIN EXECUTION BLOCK (Wrapped to prevent vanishing)
# ---------------------------------------------------------
try {
    # โหลด Assembly เท่าที่จำเป็น เหมือน WinUpdateFix
    ...
    Write-Host "   (V.3.4 Build 04.03.2026 : INIT)      " -ForegroundColor Green
...
Title="gRenam Remover by IT Groceries Shop" Height="750" Width="650" WindowStartupLocation="Manual" ResizeMode="NoResize" Background="#181818" WindowStyle="None" BorderBrush="#4CAF50" BorderThickness="2" FontFamily="Tahoma">
    ...
    # ถ้าหลุดมาถึงตรงนี้ แสดงว่ามีระบบอะไรขัดข้อง จะได้เห็นตัวหนังสือแดงๆ ไม่หายวับ
