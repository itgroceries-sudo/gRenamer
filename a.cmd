...
$TempScript = "$env:TEMP\a.cmd"
$SelfURL    = "https://raw.githubusercontent.com/itgroceries-sudo/gRenamer/main/a.cmd"
    ...
    <Grid Margin="25">
        ...
        <Grid Grid.Row="3" Margin="0,15,0,8">
            ...
            <StackPanel Grid.Column="1" Orientation="Vertical" HorizontalAlignment="Center">
                <Button x:Name="BA" Content="START SCAN" Width="300" Height="48" Background="#2E7D32" Foreground="White" Style="{StaticResource Btn}" Cursor="Hand" FontSize="18"/>
